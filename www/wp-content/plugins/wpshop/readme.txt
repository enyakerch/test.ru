...
* ST913 - Auto-compl&eacute;tion de certains champs dans l'&eacute;dition d'adresse / Auto-completion on some fields in address edit action
...
* ST826 - Combinaison option combi&eacute;es et options simples / Combined variations and single variations combinaison
* ST828 - Gestion de l'affichage des attributs / Attributes display managment
* ST829 - Envoyer l'email de confirmation de commande qu'&agrave; la r&eacute;ception totale du paiement / Send order confirmation message only when order payment is done
* ST832 - Paiement par d&eacute;faut / Default payment choice


= Version 1.3.7.7 =

Am&eacute;lorations / Improvments

* ST817 - Lien de t&eacute;l&eacute;chargement &agrave; la confirmation de commande sur une commande gratuite / Available download link on free order
...
* ST821 - Calcul du prix sur les produits &agrave; options combin&eacute;es / Combined variations product price calcul
...
* ST764 - Facture et facture d'acompte (Pr&eacute;sentation)
* ST765 - Coupons de r&eacute;duction
...
* ST739 - Envoi de la facture en PDF (Possibilit&eacute; de choisir d'envoyer ou pas la facture en PDF avec l'e-mail de confirmation de commande.)
...
* ST745 - G&eacute;n&eacute;ration des factures / Bon de colisage (Am&eacute;lioration de la g&eacute;n&eacute;ration des factures, factures d'acompte, bon de colisage et facture d'avoir.)
...
* ST728 - Facture d'avoir (Facture d'avoir sur les commandes rembours&eacute;es)
* ST729 - Accus&eacute; de r&eacute;ception sur les messages
* ST730 - Partie Devis (Administration) (Am&eacute;lioration de l'interface de cr&eacute;ation de devis dans l'administration. Simplification de l'action de l'ajout de produits au devis.)
* ST732 - Am&eacute;lioration des performances d'affichage des produits


Corrections

* ST731 - Ajout au panier des produits &agrave; option
...
* ST724 - Message priv&eacute; de commande
* ST725 - Devis (Affichage Bouton Valider mon Devis)
* ST726 - Calcul du prix des options (Sur un produit &agrave; plusieurs options de type Single)
* ST727 - Champs param&egrave;tres d'options (Les options "Afficher &agrave; partir de" et "Afficher le prix le plus bas" se s&eacute;lectionnaient syst&eacute;matiquement.)
...
* ST689 - Limitation d'utilisation des coupons de r&eacute;duction par client

Corrections

* ST690 - Attributs s&eacute;lectionn&eacute;es dans l'administration
* ST691 - D&eacute;stockage des produits
...
* ST655 - Retrait affichage donn&eacute;es GPS dans l'adresse
* ST656 - Retrait accomptes Bon de colisage
* ST657 - Listing des messages dans les r&eacute;glages

= Version 1.3.5.9 =

Corrections

* ST649 - GoogleMaps (Lien vers le fichier JS corrig&eacute;)
* ST650 - Affichage de tous les attributs affect&eacute;s aux groupes d'attributs
* ST651 - Affichage en Javascript de l'interface d'upload du fichier t&eacute;l&eacute;chargeable (Administration)
...
* ST646 - Envoi differ&eacute; du mail de confirmation de commande (Possibilit&eacute; d'envoyer l'email apr&egrave;s avoir re&ccedil;u la totalit&eacute; du paiement de la commande)
...
* ST642 - Pagination des produits ( R&eacute;sultat de recherche)
* ST643 - Coupon de r&eacute;duction
* ST644 - Duplication  de produit (Probl&egrave;me avec Yoast SEO Plugin (lien vers le produit dupliqu&eacute; -&gt;Array ))
* ST645 - Affichage d'une nouvelle adresse
* ST648 - Options obligatoires (Les options de produits &eacute;taient constamment obligatoires : probl&egrave;me corrig&eacute;.)
...
* ST618 - Probl&egrave;me de lenteur administration - http://www.eoxia.com/forums/topic/lenteur-ram-apres-installation/ (Requ&ecirc;te lanc&eacute;e &agrave; chaque rechargement de l'administration sans necessit&eacute;)
* ST619 - Probl&egrave;me d'affichage seconde image sur les produits - http://www.eoxia.com/forums/topic/message-erreur-affichage-2eme-image/ (Les images ne s'affichant pas semble &ecirc;tre plus petite &agrave; l'origine que la taille d&eacute;finie pour les images miniatures dans wordpress, ce qui implique que wordpress ne cr&eacute;&eacute; pas toutes les tailles d'images. Corrections en affichant automatiquement l'image en taille r&eacute;elle)

= Version 1.3.5.4 =

Am&eacute;liorations

* ST603 - Ajout d'attributs et d'unit&eacute; par d&eacute;faut (Attributs: marque / fournisseur / taille / r&eacute;f&eacute;rence fournisseur / r&eacute;f&eacute;rence fabricant / garntie / Unit&eacute;s: watt / cm / jour / mois / ann&eacute;e)

Corrections

* ST601 - Bouton Ajouter au panier
* ST602 - Execution des shortcodes dans les listings produit lors des changements de page
* ST604 - Recherche par filtre (Lors de la modification les valeurs des attributs &eacute;taient effac&eacute;es dans le syst&egrave;me de pr&eacute;-compilation de la recherche par filtre)
* ST605 - Affichage du prix le plus bas Fiche produit (Actif m&ecirc;me sur les options de produits avec r&eacute;duction)
...
* ST582 - Tableau de bord d'adresses (Lien &eacute;diter l'adresse choisie)
* ST584 - Affichage en liste des produits
* ST585 - Cr&eacute;ation des attributs par d&eacute;fault lors de l'installation/r&eacute;paration (Fonction file() ne se comportant pas de la m&ecirc;me fa&ccedil;on sous toute les versions)
* ST586 - Affichage Adresse de Facturation (Tableau d'administration des commandes)
* ST587 - Mail devis mis &agrave; jour
...
* ST573 - Traductions Espagnol &amp; Espagnol (Am&eacute;rique du Sud)


Corrections

* ST569 - Calcul TVA sur frais de port
* ST570 - TVA Sur frais de port et Paiement Paypal (La TVA su les frais de port n' &eacute;tait pas transmise &agrave; Paypal)
...
* ST552 - Images de cat&eacute;gories WPShop
* ST554 - Choix des attributs filtrables sur la cat&eacute;gorie
...
* ST458 - Interface de configuration frais de port. (Am&eacute;lioration interface de configuration frais de port (Frais de port Min et Max et livraison gratuite &agrave; partir de...))
* ST470 - Bon de colisage PDF
* ST472 - G&eacute;n&eacute;rer la facture avant paiement
...
* ST474 - Disponibilit&eacute; des produits avec option
...
* ST456 - Logo boutique
* ST457 - Cr&eacute;ation de compte utilisateur
...
* ST421 - Frais de port personnalis&eacute;s
* ST422 - Duplication de produit (Le produit est d&eacute;sormais dupliqu&eacute; avec ses produits.)
* ST423 - Animation Panier (Si le mini panier n'existe pas sur la page, l'animation "Dialog Box Panier" sera jou&eacute;e &agrave; la place de l'animation "Image Produit")
* ST424 - G&eacute;n&eacute;ration des produits avec option
