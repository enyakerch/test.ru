...
<div class="wps-table">
	...
	<?php foreach( $sales_informations as $sale_informations) : ?>
		<div class="wps-table-content wps-table-row">
			...
			<div class="wps-table-cell"><span class="wps-label-<?php echo $color_label[$sale_informations['order_status']]; ?>"><?php _e( $order_status[$sale_informations['order_status']], 'wpshop' ); ?></span></div>
