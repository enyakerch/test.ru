...
?>
<canvas id="wps_hourly_orders_canvas" width="" height=""></canvas>
...
<select id="wps-statistics-orders-moment-selectbox">
	<option value="General"><?php _e( 'All days', 'wpshop' ); ?></option>
	<?php foreach( $days as $day ) : ?>
	<option value="<?php echo $day; ?>"><?php _e( $day, 'wpshop'); ?></option>
	<?php endforeach; ?>
</select>
</div>
</div>