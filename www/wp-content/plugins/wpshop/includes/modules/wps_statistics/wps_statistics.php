...
DEFINE('WPS_STATISTICS_PATH', str_replace( "\\", "/", str_replace( WPS_STATISTICS_DIR, "", dirname( __FILE__ ) ) ) );
DEFINE('WPS_STATISTICS_URL', str_replace( str_replace( "\\", "/", ABSPATH), site_url() . '/', WPS_STATISTICS_PATH ) );
