<div class="wps-table-content wps-table-row">
		...
		<div class="wps-table-cell"><button class="wps-bton-first-mini-rounded wps-add-opinion-opener" id="wps-add-opinion-<?php echo $ordered_product; ?>"><?php _e( 'Add your opinion', 'wps_opinion'); ?></button></div>
</div>
